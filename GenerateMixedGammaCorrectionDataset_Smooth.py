...
def transferInputImage(inputImageIndex,filteredInputImageRGBFileNames,datasetName,inputDirectory,subInputDirectory,outputDirectory,subOutputDirectory,gammaValues,gammaIndexDictionary,displayGammaMultiplier):
    ...
    minGammaValue=min(gammaValues);
    maxGammaValue=max(gammaValues);

    gammaValue = float(numpy.random.randint(minGammaValue*100, maxGammaValue*100))/100;
    ...
    inputImageRGBFileNameInformation.insert(2, "g" + str(displayGammaValue));
...
if __name__ == '__main__':
    ...
    inputDirectory = "C:/Datasets/DukeMTMC-reID";
    outputDirectory = "C:/PaperData/IU-ReID/Duke_Mixed_G30to330_Smooth";
    datasetName="Market"
